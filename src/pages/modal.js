        ...
        <div className="modal" onClick={props.onClose}>
            <div className="modal-content" onClick={e => e.stopPropagation()}>
                ...
                <div className="modal-body">
                    ...
                    created by you yourself, tell it here explicitly. Otherwise, mention the
                    licenses/permissions under which you use such additional content from external sources.
